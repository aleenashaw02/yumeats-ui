...
const TopNav = () => {
    ...
    return (
        <div className="max-w-[1520px] mx-auto flex justify-between items-center p-4">
            ...
            <button className="bg-orange-700 text-white hidden md:flex items-center py-2 rounded-full w-[75px] justify-center">
                <BsFillCartFill size={20} className="mr-[6px]" /> Cart
            </button>
            {sideNav ? (
                ...
                <nav>
                    <ul className="flex flex-col p-4 text-gray-900">
                        <li className="text-xl py-4 flex">
                            <BsPerson size={25}
                                className='mr-4 text-white bg-black rounded-full p-[4px]'
                            />
                            My Account
                        </li>
                        <li className="text-xl py-4 flex">
